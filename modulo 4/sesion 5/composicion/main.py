...
if __name__ == "__main__":
       # main()
    supervisor = Supervisor("maria", "perez","234-5", "agricola")
    capacidades = Capacidades ("3", "8")
    supervisor_zona = SupervisorZona(supervisor, capacidades, "promedio")
    print(supervisor_zona.supervisor.apellido)